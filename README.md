...
```json
"command": "cmd",
"args": ["/c", "npx", "-y", "github:hiromu1126t-dotcom/connectedone-mcp"],
```
...
```
codex mcp add connectedone --env CONNECTEDONE_SITE_URL=https://あなたのサブドメイン.connected-one.world --env CONNECTEDONE_API_KEY=取得したAPIキー -- npx -y github:hiromu1126t-dotcom/connectedone-mcp
```
